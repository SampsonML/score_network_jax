...
dataset_31 = np.array( data_padded_31 )
...
if (plot_loss==True) and (train==True):
  ...
  plt.tight_layout()
  plt.savefig('loss_evolution_res32.png',facecolor='white',dpi=300)  
...
for i in range(n_panels):
    ...
    if (i < n_panels - 1):
        ...
        plt.axis('off')
plt.tight_layout()
plt.savefig('langevin_sampling_panels_res32.png',facecolor='white',dpi=300)
plt.show()
